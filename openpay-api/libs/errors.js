...
/**
 * Error to handle chatbot
 **/

class ChatbotError extends AppError {
    constructor() {
        super("entity doesn't exists", CODES.CHATBOT_ERROR, STATUS.BAD_REQUEST)
    }
}

/**
 * Error to send without careplan
 **/

class WithoutCareplanError extends AppError {
    constructor() {
        super("patient without careplan validated", CODES.WITHOUT_CAREPLAN_ERROR, STATUS.BAD_REQUEST)
    }
}
...
module.exports = {
    ...
    ChatbotError, // error for chatbot
    WithoutCareplanError, // send error when the patient don`t have careplan valided
}